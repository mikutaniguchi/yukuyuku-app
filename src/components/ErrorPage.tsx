    ...
    >
      <div className="h-full flex flex-col items-center justify-center">
        <div className="text-center max-w-md">
          ...
          {/* エラーメッセージ */}
          <h1 className="text-6xl font-bold text-stone-800 mb-4">{title}</h1>
          <h2 className="text-xl font-bold text-stone-700 mb-2">{subtitle}</h2>
          {message && <p className="text-stone-600 mt-2">{message}</p>}
