          ...
          <div className="border-t border-stone-200 pt-6">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
              <p className="text-red-800 text-sm mb-3">
                <strong>警告:</strong>{' '}
                アカウントを削除すると、すべての旅行データが完全に失われます。この操作は取り消せません。
              </p>

              <label className="block text-sm font-medium text-red-700 mb-2">
                削除を実行するには、あなたの名前「<strong>{user.name}</strong>
                」を入力してください:
              </label>
              <input
                type="text"
                ...
                className="w-full px-3 py-2 border border-red-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-stone-900 bg-white"
