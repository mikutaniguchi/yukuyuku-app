...
export default function CreateTripModal({ onCreateTrip, onClose }: CreateTripModalProps) {
      ...
      <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <Calendar className="w-6 h-6" style={{ color: colorPalette.aquaBlue.bg }} />
            <h2 className="text-xl font-bold text-stone-800">新しい旅行を作成</h2>
          </div>
          {onClose && (
            <button
              onClick={onClose}
